...
─────▀██▀─────
│@El_Hagag ‿ @ElBOB_x
تم تطوير السورس بواسطه مطور سورس داني وبيتا ❤
│@ElBOB_x1 ‿ @XB_0B
#-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(snak..":NameBot:")
...
var =  'مطور السورس'
elseif redis:sismember(snak..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(snak..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(snak..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(snak..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(snak..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(snak..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(snak..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(snak..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(snak..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(snak..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(snak..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(snak..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(snak..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(snak..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(snak..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(snak..':SUDO_BOT:')
message = '• ** قائمه الـمـطـوريـن : \n\n`• مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(snak..'username:'..v)
local count = redis:scard(snak..'mtwr_count'..v)
...
local monsha = redis:smembers(snak..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n• قائمه المدراء :*\n\n'
local list = redis:smembers(snak..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(snak..'admins:'..msg.chat_id_)
...
local list = redis:smembers(snak..'whitelist:'..msg.chat_id_)
...
if redis:sismember(snak..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(snak..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(snak..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(snak..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(snak..'gban_users')
...
local list = redis:smembers(snak..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(snak..':Filter_Word:'..msg.chat_id_,word) then 
return  "• **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(snak..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(snak..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(snak..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(snak..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(snak..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(snak..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(snak..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(snak..'group:ids')
message = '• **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(snak..'group:name'..v)
if info then 
...
redis:del(
snak..'group:add'..id_group,
snak..'lock_link'..id_group, 
snak..'lock_id'..id_group,
snak..'lock_spam'..id_group, 
snak..'lock_webpage'..id_group,
snak..'lock_markdown'..id_group,
snak..'lock_flood'..id_group,
snak..'lock_bots'..id_group,
snak..'mute_forward'..id_group,
snak..'mute_contact'..id_group,
snak..'mute_location'..id_group,
snak..'mute_document'..id_group,
snak..'mute_keyboard'..id_group,
snak..'mute_game'..id_group,
snak..'mute_inline'..id_group,
snak..'lock_username'..id_group,
snak..'num_msg_snak'..id_group,
snak..'replay'..id_group
)
redis:srem(snak..'group:ids',id_group)
end
...
redis:hset(snak..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(snak..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(snak..'group:add'..msg.chat_id_) then  return '• **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(snak..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(snak..':addnumberusers') or 0)
...
local lock_service = redis:get(snak..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(snak..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(snak..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
snak..'group:add'..msg.chat_id_,true,
snak..'lock_link'..msg.chat_id_,true, 
snak..'lock_id'..msg.chat_id_,true,
snak..'lock_spam'..msg.chat_id_,true,
snak..'lock_webpage'..msg.chat_id_,true,
snak..'lock_markdown'..msg.chat_id_,true,
snak..'lock_flood'..msg.chat_id_,true,
...
snak..'mute_keyboard'..msg.chat_id_,true,
snak..'mute_game'..msg.chat_id_,true,
snak..'mute_inline'..msg.chat_id_,true,
snak..'lock_username'..msg.chat_id_,true,
snak..'num_msg_snak'..msg.chat_id_,5, 
snak..'replay'..msg.chat_id_,true
)

redis:sadd(snak..'group:ids',msg.chat_id_) 
redis:sadd(snak..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(snak..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(snak..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(snak..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(snak..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(snak..'username:'..UserID,'username',Resolv)
redis:sadd(snak..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(snak..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(snak..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(snak..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(snak..'username:'..UserID,'username',Resolv)
redis:sadd(snak..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(snak..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(snak..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(snak..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(snak..'username:'..UserID, 'username', Resolv)
redis:sadd(snak..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(snak..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(snak..'whitelist:'..ChatID,UserID)
...
if redis:sismember(snak..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(snak..'username:'..UserID, 'username', Resolv)
redis:sadd(snak..'owners:'..ChatID,UserID)
...
if redis:sismember(snak..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(snak..'username:'..UserID, 'username', Resolv)
redis:sadd(snak..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(snak..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(snak..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(snak..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(snak..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(snak..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(snak..'username:'..UserID, 'username', Resolv)
redis:sadd(snak..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(snak..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(snak..'banned:'..ChatID,UserID)
...
if redis:sismember(snak..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(snak..'username:'..UserID, 'username', Resolv)
redis:sadd(snak..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(snak..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(snak..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(snak..'username:'..UserID, 'username',Resolv)
redis:sadd(snak..'gban_users',UserID)
...
redis:srem(snak..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(snak..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(snak..'username:'..UserID, 'username', Resolv)
redis:sadd(snak..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(snak..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(snak..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(snak..'username:'..UserID, 'username', UserName)
redis:sadd(snak..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(snak..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'• **العضو » ❪ '..UserName..' ❫\n• **الايدي » ❪ `'..UserID..'` ❫\n• **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(snak..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(snak..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المدير\n") 
elseif redis:sismember(snak..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(snak..'username:'..UserID, 'username', Resolv)
redis:sadd(snak..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(snak..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(snak..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'• **العضو » '..USERNAME..' \n• ** الايدي » (`'..UserID..'`)\n• **انه بالتأكيد ليس مطور \n') end
redis:srem(snak..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(snak..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(snak..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(snak..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(snak..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*•*` اعدادات المجموعه :` \n"
.."\n• التعديل «» "..(redis:get(snak..'lock_edit'..msg.chat_id_) or 'false')
.."\n• الروابط «» "..(redis:get(snak..'lock_link'..msg.chat_id_) or 'false')
.."\n• التاك «» "..(redis:get(snak..'lock_tag'..msg.chat_id_) or 'false')
.."\n• المعرفات «» "..(redis:get(snak..'lock_username'..msg.chat_id_) or 'false')
.."\n• التكرار «» "..(redis:get(snak..'lock_flood'..msg.chat_id_) or 'false')
.."\n• الكلايش «» "..(redis:get(snak..'lock_spam'..msg.chat_id_) or 'false')
.."\n• الويب «» "..(redis:get(snak..'lock_webpage'..msg.chat_id_) or 'false')
.."\n• الماركدوان «» "..(redis:get(snak..'lock_markdown'..msg.chat_id_) or 'false')
.."\n• بالطرد البوتات «» "..(redis:get(snak..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n• البوتات «» "..(redis:get(snak..'lock_bots'..msg.chat_id_) or 'false')
.."\n• عدد التكرار «» "..(redis:get(snak..'num_msg_snak'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n•`اعدادات الوسائط :`\n"
.."\n*• *المتحركه «» "..(redis:get(snak..'mute_gif'..msg.chat_id_) or 'false')
.."\n• الدردشه «» "..(redis:get(snak..'mute_text'..msg.chat_id_) or 'false')
.."\n• الانلاين «» "..(redis:get(snak..'mute_inline'..msg.chat_id_) or 'false')
.."\n• الالعاب «» "..(redis:get(snak..'mute_game'..msg.chat_id_) or 'false')
.."\n• الصور «» "..(redis:get(snak..'mute_photo'..msg.chat_id_) or 'false')
.."\n• الفيديو «» "..(redis:get(snak..'mute_video'..msg.chat_id_) or 'false')
.."\n• البصمات «» "..(redis:get(snak..'mute_audio'..msg.chat_id_) or 'false')
.."\n• الصوت «» "..(redis:get(snak..'mute_voice'..msg.chat_id_) or 'false')
.."\n• الملصقات «» "..(redis:get(snak..'mute_sticker'..msg.chat_id_) or 'false')
.."\n• الجهات «» "..(redis:get(snak..'mute_contact'..msg.chat_id_) or 'false')
.."\n• التوجيه «» "..(redis:get(snak..'mute_forward'..msg.chat_id_) or 'false')
.."\n• الموقع «» "..(redis:get(snak..'mute_location'..msg.chat_id_) or 'false')
.."\n• الملفات «» "..(redis:get(snak..'mute_document'..msg.chat_id_) or 'false')
.."\n• الاشعارات «» "..(redis:get(snak..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n• الكيبورد «» "..(redis:get(snak..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*`اعدادات اخرى : `"
.."\n\n*•*الترحيب «» "..welcomex
.."\n*•*الردود «» "..replayx
...
.."\n*•*الويب «» "..(redis:get(snak..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*•*الماركدوان «» "..(redis:get(snak..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*•*البوتات بالطرد «» "..(redis:get(snak..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*•*البوتات «» "..(redis:get(snak..'lock_bots'..msg.chat_id_) or 'false')
.."\n*•*عدد التكرار «» "..(redis:get(snak..'num_msg_snak'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*اعدادات التقـييد :\n"
.."\n*•*التقييد بالتوجيه «» "..(redis:get(snak..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالصور «» "..(redis:get(snak..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالروابط «» "..(redis:get(snak..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالمتحركه «» "..(redis:get(snak..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*•*التقييد الفيديو «» "..(redis:get(snak..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
