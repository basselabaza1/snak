...
local NumMnsha = redis:scard(snak..'lock:kara:'..msg.chat_id_)
if NumMnsha ==0 then 
return "• عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(snak..':KARA_BOT:'..msg.chat_id_)
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/baselabaza/bita.githup.io/master/GetVersion.txt' ) or 0
...
✧ 𝙳𝙴𝚅1 ┆ [˹ 𝙰𝙼𝚁 𝙷𝙰𝙶𝙰𝙶𖤝.](t.me/El_Hagag)
✧ 𝙳𝙴𝚅2 ┆ [˹ 𝙴𝙻𝙱𝙾𝙱𖤝.](t.me/ElBOB_x)
✧ 𝙲𝙷 ┆ [˹ 𝚂𝙽𝙸𝙺𖤝.](t.me/Sourcesnak)
┈ ┈ ┈ ┈ ┈ ┈ ┈
...
elseif Text== "باسل" or Text== "اباظة" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس  ✨](https://t.me/xb_0b)")
elseif Text== "حجاج" or Text== "حكاك" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس سنيك↯](https://t.me/El_Hagag)")
elseif Text== "البوب" or Text== "بوب" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس سنيك↯](https://t.me/ElBOB_x)")
